...
class player (object):
    def __init__ (self,x,y,width,height):
        ...
        self.jumpCount = 10
        self.standing = True
        self.hatbox=(self.x + 20,self.y,28,60)
    ...
    def draw (self,win):
        ...
        self.hatbox = (self.x + 20,self.y,28,60)
        # pygame.draw.rect(win,(255,0,0),self.hatbox,2)
...
while run:
    ...
    for bullet in bullets:
        if bullet.y- bullet.radius<goblin.hatbox[1]+goblin.hatbox[3] and bullet.y+bullet.radius>goblin.hatbox[1]:
            if bullet.x+bullet.radius>goblin.hatbox[0] and bullet.x- bullet.radius<goblin.hatbox[0]+goblin.hatbox[2]:
                goblin.hit()
                score = score + 1
